...
func CompactByUniqIDFunc[T any, K comparable](slice []T, idFunc func(index int, item T) K) []T {
...
func DistinctByUniqIDFunc[T any, K comparable](slice []T, uniqIDFunc func(index int, item T) K) []T {
...
func IsUniqByUniqIDFunc[T any, K comparable](slice []T, idFunc func(index int, item T) K) bool {
